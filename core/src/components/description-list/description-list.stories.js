...
const DL_configuration = {
  ...
  compact: {
    ...
    colon: html`<span class="fudis-dl-item-term__compact__colon">&colon;</span>`,
    parenthesis_open: html`<span class="fudis-dl-item-details__compact__parenthesis"
      >&#40;</span
    >`,
    parenthesis_closed: html`<span
      ...
      >&#41;</span
    >`,
    comma: html`<span class="fudis-dl-item-details__compact__comma">&comma;</span>`,
  },
};
