...
export const Small = () => `
  <div class="fudis-loading-spinner">
    <div class="fudis-loading-spinner__ui-content">
      <svg
        class="fudis-loading-spinner__svg fudis-loading-spinner__variant__sm"
        aria-hidden="true"
        width="24"
        height="24"
        viewBox="0 0 24 24"
      ...
      <p class="fudis-body-text fudis-body-text__center fudis-body-text__md-regular">
        Loading
      </p>
    </div>
  </div>
...
export const Large = () => `
  <div class="fudis-loading-spinner">
    <div class="fudis-loading-spinner__ui-content">
      <svg
        class="fudis-loading-spinner__svg fudis-loading-spinner__variant__lg"
        aria-hidden="true"
        width="24"
        height="24"
        viewBox="0 0 24 24"
      ...
      <p class="fudis-body-text fudis-body-text__center fudis-body-text__lg-regular">
        Loading
      </p>
    </div>
  </div>
