...
<Meta title="Documentation/Development/Practises/Naming Conventions" />
...
1. [Prefix](#prefix)
2. [HTML Selector](#html-selector)
3. [CSS/SCSS Class Names](#cssscss-class-names)
4. [Foundations and Design Tokens](#foundations-and-design-tokens)

## Prefix

Fudis often uses selector prefix **fudis**. Prefix prevents collision with consumers existing design tokens. Prefix is used in e.g. component's HTML selector, CSS/SCSS class names and utility functions.
...
The main star of CSS class name, usually the component itself.
