...
3. [PR Labels](#pr-labels)
4. [PR Naming](#pr-naming)
...
- Examples
  - DS-1337-button-component-ver-1
  - DS-42-table-component-part-2-fix-headings
...
- Examples
  ...
  - deps: update prettier and stylelint to latest
...
- Priority list can be seen in 'release-labels.yml' file. where e. g. 'Breaking change' label is the highest priority and 'Dependencies' is the lowest.

## PR Naming

- Title consists of two parts
- First part: In square brackets the feature, component, area of Fudis Core work etc. what does the PR affect
...
- Examples
  ...
  - \[NavigationComponent]: First version of the component, documentation and vr tests
